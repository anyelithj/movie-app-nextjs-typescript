...
import { modalState, movieState } from "../atom/ModaAtoml"
import {useRecoilState} from "recoil"
import { HiCheckCircle, HiPlusCircle, HiThumbUp, HiVolumeOff, HiVolumeUp, HiX } from "react-icons/hi"
...
function Modal() {
    ...
    const [muted, setMuted] = useState(true)//false 
    const { user } = useAuth()
